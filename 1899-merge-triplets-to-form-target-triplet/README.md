...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/merge-triplets-to-form-target-triplet/)
...
**My Solution:** [1899-Merge-Triplets-to-Form-Target-Triplet.py](./1899-Merge-Triplets-to-Form-Target-Triplet.py)
